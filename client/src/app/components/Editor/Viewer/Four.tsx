...
const Four = ({ media, current, renderItem }) => (
  <div className="four-container" style={{ height: "400px" }}>
    ...
    <div
      style={{
        width: `${current === 2 || current === 3 ? "70%" : "15%"}`,
    ...
    >
      <div
        className={current === 2 ? "four-small-active" : "four-small"}
        style={calculateStyleForFour(2, current)}
      >
        {renderItem(media[2], current === 2)}
      </div>
      <div
        className={current === 3 ? "four-small-active" : "four-small"}
        style={calculateStyleForFour(3, current)}
      >
